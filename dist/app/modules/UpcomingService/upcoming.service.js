...
const insertIntoDb = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.upcomingService.create({ data });
    return result;
});
const getAllData = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: upcoming_constants_1.UpcomingServiceSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
...
const updateData = (id, data) => __awaiter(void 0, void 0, void 0, function* () {

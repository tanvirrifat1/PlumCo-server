...
const getUserFromDb = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { size, limit, page, skip } = paginationHelper_1.paginationHelpers.calculatePagination(options);
